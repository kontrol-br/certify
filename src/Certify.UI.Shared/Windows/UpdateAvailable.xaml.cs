...
namespace Certify.UI.Windows
{
    public partial class UpdateAvailable
    {
        ...
        private async Task<string> UpdatePreview()
        {
            ...
            if (_update == null)
            {
                return "Informações da atualização indisponíveis. Não prossiga com a atualização até que isso seja resolvido.";
            }
            ...
            var result = Markdown.ToHtml(sb.ToString(), _markdownPipeline);
